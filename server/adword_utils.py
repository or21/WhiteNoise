...
def add_label_to_keyword(kw, label_text):
    ...
    try:
        ...
        logger.info("Label '{}' exists, looking for it's ID".format(label_text))
        service_selector = {
            'fields': ['LabelId'],
            'predicates': {
                'field': 'LabelName',
    ...
    try:
        ...
        logger.debug("Label {} was added to keyword {} on ad group {}".format(label_text, kw.name, kw.ad_group))
